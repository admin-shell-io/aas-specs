...
* Added metamodel semantic ID for every class and attribute element (before only grammar). All elements increased in Version to V3.1 I
...
|   | Identifier a| data type: change length from 2000 to 2048 characters
