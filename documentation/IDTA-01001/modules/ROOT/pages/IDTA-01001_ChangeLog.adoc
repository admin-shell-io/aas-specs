...
* Entity/entityType and Constraint AASd-014: now optional (https://github.com/admin-shell-io/aas-specs/issues/287[#287])
...
* Terms and Definitions adopted to IEC 63278-1:2023 (before IEC 63278-1 Draft July 2022 was the basis), also abbreviations partly adopted; changed definitions:
	** changed: asset
