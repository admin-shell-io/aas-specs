...
| {empty} | xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Blob[Blob/contentType] a| now optional
| {empty} | xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Entity[Entity/entityType] a| now optional
| {empty} | xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#File[File/contentType] a| now optional
...
|{empty} | xref:Spec/IDTA-01001_Metamodel_Core.adoc#AssetKind[AssetKind/Role] | New value in enumeration
|===
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_Core.adoc#AssetKind[AssetKind/Instance] |Updated description of value "Instance" of enumeration "AssetKind" conformant to IEC 63278-1
|{empty} |xref:Spec/IDTA-01001_Metamodel_Core.adoc#AssetKind[AssetKind/Type] |Updated description of value "Type" of enumeration "AssetKind" conformant to IEC 63278-1
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_Common.adoc#Qualifier[Qualifier] |No longer inherits from abstract class "Constraint"
...
| |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Range[Range] | set to \<<Experimental>>
|{empty} |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Range[Range/valueType] |Type changed from DataTypeDef to DataTypeDefXsd
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |Before as specified via DataTypeDef, now any xsd atomic type as specified via DataTypeDefXsd
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#AasIdentifiables[AasIdentifiables] |New enumeration used for References, includes abstract Identifiable +
 +
Before: Identifiables
|{empty} |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
|{empty} |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
|{empty} |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#AasSubmodelElements[AasSubmodelElements] |New enumeration used for References +
 +
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_Core.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset because not specific to Asset but AAS
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] |Former BasicEvent +
 +
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#ContentType[ContentType] |Former name: MimeType +
Maximum length defined: 100 characters
|{empty} |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + added prefix rdf: to every value in enumeration
|{empty} |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd] |Enumeration that corresponds to anySimpleTypes of XML Schema 1.0 +
 +
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Direction[Direction] |New Enumeration for BasicEventElement
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_Environment.adoc#Environment[Environment] |New class for entry point for Asset Administration Shells, submodels and concept descriptions.
|{empty} |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EventElement[EventElement] |Former name: Event +
Set to \<<Experimental>>
|{empty} |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] |New experimental class for event payload +
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_Common.adoc#Extension[Extension] |New class, part of new abstract class HasExtensions
| |Extension/name |{empty}
| |Extension/refersTo |{empty}
| |Extension/valueType |{empty}
| |Extension/valueType |{empty}
|{empty} |File/contentType |Fromer File/mimeType
|{empty} |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#FragmentKeys[FragmentKeys] |New enumeration used for References
|{empty} |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#GenericFragmentKeys[GenericFragmentKeys] |New enumeration used for References
|{empty} |GenericGloballyIdentifiers |New enumeration used for References
|{empty} |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#GloballyIdentifiables[GloballyIdentifiables] |New enumeration used for References
|{empty} |xref:Spec/IDTA-01001_Metamodel_Common.adoc#HasExtensions[HasExtensions] |New abstract class, inherited by Referable
|{empty} |HasSemantics/supplementalSemanticId |New attribute
|{empty} |Identifiable/id |Substitute for Identifiable/identification
|{empty} |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#KeyTypes[KeyTypes] |Before: KeyElements +
 +
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#LabelType[LabelType] |New string type with maximum 64 characters
|{empty} |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
| |xref:Spec/IDTA-01001_Metamodel_Core.adoc#ModellingKind[ModellingKind] |Renamed enumeration, before: ModelingKind
|{empty} |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] |Substitute for LangStringSet with short multi-language strings, maximum 64 characters
|{empty} |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |Substitute for LangStringSet with long multi-language strings, maximum 64 characters
|{empty} |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#NameType[NameType] |New string type with maximum 128 characters
|{empty} |Qualifier/kind |New experimental attribute for Qualifier
|{empty} |xref:Spec/IDTA-01001_Metamodel_Common.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#ReferenceTypes[ReferenceTypes] |New enumeration for Reference/type
|{empty} |ReferenceTypes/ExternalReference |Enumeration value, was named GlobalReference before
|{empty} |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#Resource[Resource] |new type for AssetInformation/defaultThumbnail
|{empty} |ShortNameType |New string type with maximum 64 characters
|{empty} |xref:Spec/IDTA-01001_Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |New type for AssetInformation/specificAssetId
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |New experimental enumeration for BasicEventElement
|{empty} |SubmodelElementElements |Enumeration for submodel elements (split of ReferableElements)
|{empty} |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and collections
...
| |xref:Spec/IDTA-01001_Metamodel_Core.adoc#AdministrativeInformation[AdministrativeInformation] a|Stereotype \<<dataType>> removed
...
| |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] a|Set to \<<Experimental>>
...
|(x)footnote:[Derived Schemata used Base64Binary and not hexBinary, therefore this change is considered to be backward compatible for most applications.] a|xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#BlobType[BlobType] |Primitive changed from "group of bytes" to Base64Binary
| |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#ContentType[ContentType] a|Maximum length defined: 100 characters
...
| |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Direction[Direction] a|Set to \<<Experimental>>
...
| |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EventElement[EventElement] a|Set to \<<Experimental>>
| |EventElement/duration a|Type changed from dateTimeStamp to dateTime
| |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] a|Set to \<<Experimental>>
...
|x |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#Identifier[Identifier] a|Maximum length defined: 2,000 characters
...
|x |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#PathType[PathType] a|Same as Identifier; length constraint added
| |PrimitiveTypes |Removed
| |Qualifier/kind a|Set to \<<Experimental>>
|x |xref:Spec/IDTA-01001_Metamodel_Common.adoc#QualifierType[QualifierType] a|Type changed from string to NameType; length constraint added
...
| |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#Resource[Resource] a|Stereotype \<<DataType>> removed.
...
| |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#RevisionType[RevisionType] |New type for _AdministrativeInformation/revision_ with length constraints and regular expression
| |ShortNameType |New string type with maximum 64 characters
| |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#VersionType[VersionType] |New type for _AdministrativeInformation/version_ with length constraints and regular expression
|===
...
|{empty} |xref:Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and structs
