...
* Change PathType: support complete URI scheme for files RFC2396/RFC2732 conformant to anyURI of XML Schema 1.0  (https://github.com/admin-shell-io/aas-specs/issues/299[#299])
