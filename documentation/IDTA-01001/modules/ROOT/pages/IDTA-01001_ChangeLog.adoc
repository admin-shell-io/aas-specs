...
|   | xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#AssetKind[AssetKind] a| Add new value "Role" to enumeration AssetKind
|   | xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Entity[Entity/entityType] a| now optional
|   | xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#Identifier[Identifier] a| data type: change length from 2000 to 2024 characters
|   | xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#NameType[NameType] a| implicit change due to change of Constraint AASd-002
|   | xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#PathType[PathType] a| extend data type to support complete URI scheme for files RFC2396
|   | xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#Referable[Referable/idShort] a| implicit change because constraint AASd-002 now also allows hyphen
...
|  | xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#AssetKind[AssetKind/Role] | New value in enumeration
|===
...
|===
|*Nc* |*V3.1 Change w.r.t. V3.0* |*Comment*
|(x)| xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement/Direction] a| (bugfix in Text only) attribute starts with small letter 
|(x) | xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement/State] a|  (bugfix in Text only) attribute starts with small letter 
|x| xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd] a| BUGFIX: Remove xs:yearMonthDuration from enumeration

Updated links to XML Schema 1.0 (not 1.1)
|(x)| xref:page$IDTA-01001_DataSpecificatins.adoc#EmbeddedDataSpecification[EmbeddedDataSpecification/dataSpecification] a| (bugfix in Text only) now mandatory
|(x) | xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] a| (bugfix in Text only) maxLength=128 (as derived and implemented)
|(x)  | xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#Qualifier[Qualifier/Kind] a| (bugfix in Text only) attribute starts with small letter 
|===
...
|  |xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#AssetKind[AssetKind/Instance] |Updated description of value "Instance" of enumeration "AssetKind" conformant to IEC 63278-1
|  |xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#AssetKind[AssetKind/Type] |Updated description of value "Type" of enumeration "AssetKind" conformant to IEC 63278-1
|x |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEvent] |Renamed to BasicEventElement and set to \<<Experimental>>

|file:///C:/__localWork/Asset%20Administration%20Shell%20-%20Verwaltungsschale/Verwaltungsschale%20im%20Detail%20-%20part%201a%20V3.0/Change%202.0%20-%203.0.xlsx#RANGE!#REF![(x)link:#bib2[[2\]]] |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#BlobType[BlobType] |Primitive changed from "group of bytes" to Base64Binary

|x |ConceptDictionary |Removed
|x |Constraint |Abstract class removed. Formula now used in Security part only
|x |xref:page$IDTA-01001_DataSpecifications.adoc#DataSpecification[DataSpecification] |No longer inherits from Identifiable. However, same attribute names and types
|x |DataSpecification/description |Type changed from LangStringSet to MultiLanguageTextType, thus adding a length constraint
| |xref:page$IDTA-01001_DataSpecifications.adoc#DataSpecificationContent[DataSpecificationContent] |Stereotype \<<Template>> added
...
|x |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#Identifier[Identifier] a|
Type changed
...
|x |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#PathType[PathType] |Same as Identifier, i.e. length constraint added
...
|  |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#Qualifier[Qualifier] |No longer inherits from abstract class "Constraint"
|  |Qualifier/valueType |Type changed from DataTypeDef to DataTypeDefXsd
|x |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#QualifierType[QualifierType] |Type changed from string to NameType (i.e. length constraint added)
|  |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Range[Range/valueType] |Type changed from DataTypeDef to DataTypeDefXsd
...
|  |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |Before as specified via DataTypeDef, now any xsd atomic type as specified via DataTypeDefXsd
| x |View |Removed
|===
...
|  |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#AasIdentifiables[AasIdentifiables] |New enumeration used for References, includes abstract Identifiable +
 +
Before: Identifiables
|  |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
|  |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
|  |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#AasSubmodelElements[AasSubmodelElements] |New enumeration used for References +
 +
...
|  |xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset because not specific to Asset but AAS
...
|  |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] |Former BasicEvent +
 +
...
|  |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#ContentType[ContentType] |Former name: MimeType +
Maximum length defined: 100 characters
|  |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + added prefix rdf: to every value in enumeration
|  |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd] |Enumeration that corresponds to anySimpleTypes of XML Schema 1.0 +
 +
...
|  |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Direction[Direction] |New Enumeration for BasicEventElement
...
|  |xref:page$Spec/IDTA-01001_Metamodel_Environment.adoc#Environment[Environment] |New class for entry point for Asset Administration Shells, submodels and concept descriptions.
|  |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EventElement[EventElement] |Former name: Event +
Set to \<<Experimental>>
|  |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] |New experimental class for event payload +
...
|  |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#Extension[Extension] |New class, part of new abstract class HasExtensions
| |Extension/name | 
| |Extension/refersTo | 
| |Extension/valueType | 
| |Extension/valueType | 
|  |File/contentType |Fromer File/mimeType
|  |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#FragmentKeys[FragmentKeys] |New enumeration used for References
|  |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#GenericFragmentKeys[GenericFragmentKeys] |New enumeration used for References
|  |GenericGloballyIdentifiers |New enumeration used for References
|  |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#GloballyIdentifiables[GloballyIdentifiables] |New enumeration used for References
|  |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#HasExtensions[HasExtensions] |New abstract class, inherited by Referable
|  |HasSemantics/supplementalSemanticId |New attribute
|  |Identifiable/id |Substitute for Identifiable/identification
|  |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#KeyTypes[KeyTypes] |Before: KeyElements +
 +
...
|  |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#LabelType[LabelType] |New string type with maximum 64 characters
|  |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
| |xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#ModellingKind[ModellingKind] |Renamed enumeration, before: ModelingKind
|  |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] |Substitute for LangStringSet with short multi-language strings, maximum 64 characters
|  |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |Substitute for LangStringSet with long multi-language strings, maximum 64 characters
|  |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#NameType[NameType] |New string type with maximum 128 characters
|  |Qualifier/kind |New experimental attribute for Qualifier
|  |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
...
|  |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#ReferenceTypes[ReferenceTypes] |New enumeration for Reference/type
|  |ReferenceTypes/ExternalReference |Enumeration value, was named GlobalReference before
|  |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#Resource[Resource] |new type for AssetInformation/defaultThumbnail
|  |ShortNameType |New string type with maximum 64 characters
|  |xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |New type for AssetInformation/specificAssetId
...
|  |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |New experimental enumeration for BasicEventElement
|  |SubmodelElementElements |Enumeration for submodel elements (split of ReferableElements)
|  |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and collections
...
| |xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#AdministrativeInformation[AdministrativeInformation] |Stereotype \<<dataType>> removed
...
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] |Set to \<<Experimental>>
...
|(x)footnote:[Derived Schemata used Base64Binary and not hexBinary, therefore this change is considered to be backward compatible for most applications.] |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#BlobType[BlobType] |Primitive changed from "group of bytes" to Base64Binary
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#ContentType[ContentType] |Maximum length defined: 100 characters
...
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Direction[Direction] |Set to \<<Experimental>>
...
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EventElement[EventElement] |Set to \<<Experimental>>
| |EventElement/duration |Type changed from dateTimeStamp to dateTime
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] |Set to \<<Experimental>>
...
|x |HasKind/kind |Type changed from ModelingKind to ModellingKind
|x |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#Identifier[Identifier] |Maximum length defined: 2,000 characters
...
|x |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#PathType[PathType] |Same as Identifier; length constraint added
| |PrimitiveTypes |Removed
| |Qualifier/kind |Set to \<<Experimental>>
|x |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#QualifierType[QualifierType] |Type changed from string to NameType; length constraint added
...
|x |ReferenceTypes/GlobalReference |Renamed to ExternalReference
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#Resource[Resource] |Stereotype \<<DataType>> removed.
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |Set to \<<Experimental>>
...
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#LabelType[LabelType] |New string type with maximum 64 characters
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
| |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#ModellingKind[ModellingKind] |Renamed enumeration, before: ModelingKind
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] |Substitute for LangStringSet with short multi-language strings, maximum 64 characters
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |Substitute for LangStringSet with long multi-language strings, maximum 64 characters
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#NameType[NameType] |New string type with maximum 128 characters
| |ReferenceTypes/ExternalReference |Enumeration value: before: GlobalReference
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#RevisionType[RevisionType] |New type for _AdministrativeInformation/version_ with length constraints and regular expression
| |ShortNameType |New string type with maximum 64 characters
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#VersionType[VersionType] |New type for _AdministrativeInformation/revision_ with length constraints and regular expression
|===
...
| |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#AdministrativeInformation[AdministrativeInformation] |Bugfix: Stereotype "DataType" added

| |AnnotatedRelationship/annotation |Bugfix: Type changed from ModelReference<xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#DataElement[DataElement]> to DataElement
| |anySimpleTypeDef |Type removed, was no longer used in any class definition, was mentioned in text only
|x |Asset |Removed, asset referenced via AssetInformation/globalAssetId only
...
| |xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset, because not specific to Asset but to AAS
| |AssetInformation/assetKind |Former Asset/assetKind
| |AssetInformation/globalAssetId |Former Asset/identification/id
| |AssetInformation/specificAssetId |Former Asset/assetIdentificationModel
| |AssetInformation/thumbnail |Optional Attribute of new class AssetInformation that was not available in Asset class before
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] a|
...
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#ContentType[ContentType] |Former name: MimeType
| |dateTimeStamp |New data type for metamodel as used in EventPayload
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + prefix rdf: added to every value in enumeration
| |DataTypeDefXsd a|
...
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] |New class for event payload
...
| |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#ReferenceTypes[ReferenceTypes] |New enumeration for Reference/type
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |New enumeration for BasicEventElement
| |xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |New type for AssetInformation/specificAssetId
| |SpecificAssetId/name |New type for AssetInformation/specificAssetId
| |SpecificAssetId/value |New type for AssetInformation/specificAssetId
...
| |SubmodelElementElements |Enumeration for submodel elements (split of ReferableElements)
|  |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and structs
| |SubmodelElementList/orderRelevant |Similar to SubmodelElementCollection/ordered
| |SubmodelElementList/value |Similar to SubmodelElementCollection/value but ordered and with all elements having the same semanticId
| |SubmodelElementList/semanticIdListElement |Attribute of new class SubmodelElementList
| |SubmodelElementList/typeValueListElement |Attribute of new class SubmodelElementList
...
|===
|*nc* |*V3.0RC02 Change w.r.t. V2.0.1* |*Comment*
| |xref:page$IDTA-01001_DataSpecifications.adoc#DataSpecification[DataSpecification] a|
...
| |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#AdministrativeInformation[AdministrativeInformation] |Bugfix: Stereotype "DataType" added
| |AnnotatedRelationship/annotation |Type changed from ModelReference<xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#DataElement[DataElement]> to DataElement
...
|x |Event |Renamed to EventElement
|x |Extension/refersTo |Type changed from Reference to ModelReference<xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#Referable[Referable]>
...
| |Property/valueType |Type changed from DataTypeDef to DataTypeDefXsd
|x |Qualifiable/qualifier |Type changed from Constraint to Qualifier
| |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#Qualifier[Qualifier] |Does not inherit from abstract class "Constraint" any longer
| |Qualifier/valueType |Type changed from DataTypeDef to DataTypeDefXsd
| |Range/valueType |Type changed from DataTypeDef to DataTypeDefXsd
| |Referable/idShort |Now optional, was mandatory
|x |ReferableElements |Substituted with enumeration AasSubmodelElements and AasIdentifiables
...
| |RelationshipElement/first |Type changes from model reference Referable to Reference (global or model reference)
| |RelationshipElement/second |Type changes from model reference Referable to Reference (global or model reference)
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |Before as specified via DataTypeDef, now any xsd atomic type as specified via DataTypeDefXsd + Prefix xs: added to every value in list
...
| |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
| |xref:page$Spec/IDTA-01001_Metamodel_Referencing.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
| |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] |Former name: BasicEvent
...
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#ContentType[ContentType] |Former name: MimeType
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + prefix rdf: added to every value in enumeration
| |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd] |Enumeration consisting of enumerations decimalBuildInTypes, durationBuildInTypes, PrimitiveTypes that correspond to anySimpleTypes of xsd. + prefix xs: added to every value in enumeration
| |dateTimeStamp |New data type for metamodel as used in EventPayload
...
| |xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
| |Referable/checksum |
| |xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |Before: IdentifierKeyValuePair, was renamed
...
| |xref:page$IDTA-01001_DataSpecifications.adoc#DataSpecification[DataSpecification] |Bugfix, is not abstract
...
| |xref:page$IDTA-01001_DataSpecifications.adoc#HasDataSpecification[HasDataSpecification] |Was abstract before
...
|x |xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#OperationVariable[OperationVariable] |No longer inherits from SubmodelElement
...
|===
|*V2.0* |*Comment*
|xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#AnnotatedRelationshipElement[AnnotatedRelationshipElement] |New submodel element, inheriting from RelationshipElement
|Asset/billOfMaterial |New attribute
|xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#AssetKind[AssetKind] |New enumeration type
|BasicEvent |New submodel element, inherits from Event
|xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Capability[Capability] |New submodel element
...
|xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Entity[Entity] |New submodel Element
|xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#EntityType[EntityType] |New enumeration type
...
|xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#LangStringSet[LangStringSet] |New type, used for example in MultiLanguageProperty
|LevelType |New enumeration type
|xref:page$Spec/IDTA-01001_Metamodel_Core.adoc#ModellingKind[ModellingKind] |New enumeration type
|xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#MultiLanguageProperty[MultiLanguageProperty] |New submodel element
|Qualifier/valueType |New attribute to be consistent with valueType of Property etc.
|xref:page$Spec/IDTA-01001_Metamodel_SubmodelElements.adoc#Range[Range] |New submodel element
...
|xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |New type, used for example for Property value
|ValueList |New class
