...
* Change PathType: support complete URI scheme for files RFC2396/RFC2732  (https://github.com/admin-shell-io/aas-specs/issues/299[#299])
...
* Individual versioning of metamodel element IDs (note: the version of many 
...
* Terms and Definitions adopted to IEC 63278-1:2023 (before IEC 63278-1 Draft July 2022 was the basis), also abbreviations partly adopted; changes:
	** changed: asset
...
* (Editorial) DataTypeDefXsd links now correctly to xmlschema11-2, not to xsd V1.1 (https://github.com/admin-shell-io/aas-specs/issues/312[#312]) (as implemented in schemata)
* (Editorial) make EmbeddedDataSpecification/dataSpecification mandatory (as implemented in schemata) (https://github.com/admin-shell-io/aas-specs/issues/296[#296])
...
| | PathType a| extend data type to support complete URI scheme for files RFC 2396/RFC 2732
...
<<<<<<< HEAD:documentation/IDTA-01001/modules/ROOT/pages/IDTA-01001_ChangeLog.adoc
...
>>>>>>> origin/IDTA-01001-3-1_working:documentation/IDTA-01001/modules/ROOT/pages/Annex/IDTA-01001_ChangeLog.adoc
...
|x |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#PathType[PathType] |Same as Identifier, i.e. length constraint added
...
|x |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#QualifierType[QualifierType] |Type changed from string to NameType (i.e. length constraint added)
...
|  |xref:page$IDTA-01001_Metamodel.adoc#AasIdentifiables[AasIdentifiables] |New enumeration used for References, includes abstract Identifiable +
 +
Before: Identifiables
|  |xref:page$IDTA-01001_Metamodel_Common.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
|  |xref:page$IDTA-01001_Metamodel_Common.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
|  |xref:page$IDTA-01001_Metamodel.adoc#AasSubmodelElements[AasSubmodelElements] |New enumeration used for References +
 +
...
|  |xref:page$IDTA-01001_Metamodel_Core.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset because not specific to Asset but AAS
...
|  |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] |Former BasicEvent +
 +
...
|  |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + added prefix rdf: to every value in enumeration
|  |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd] |Enumeration that corresponds to anySimpleTypes of XML Schema 1.0 +
 +
...
Set to \<<Experimental>>
|  |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] |New experimental class for event payload +
...
|  |xref:page$IDTA-01001_Metamodel.adoc#Extension[Extension] |New class, part of new abstract class HasExtensions
| |Extension/name | 
| |Extension/refersTo | 
| |Extension/valueType | 
| |Extension/valueType | 
|  |File/contentType |Fromer File/mimeType
|  |xref:page$IDTA-01001_Metamodel_Referencing.adoc#FragmentKeys[FragmentKeys] |New enumeration used for References
|  |xref:page$IDTA-01001_Metamodel_Referencing.adoc#GenericFragmentKeys[GenericFragmentKeys] |New enumeration used for References
|  |GenericGloballyIdentifiers |New enumeration used for References
|  |xref:page$IDTA-01001_Metamodel_Referencing.adoc#GloballyIdentifiables[GloballyIdentifiables] |New enumeration used for References
|  |xref:page$IDTA-01001_Metamodel_Common.adoc#HasExtensions[HasExtensions] |New abstract class, inherited by Referable
|  |HasSemantics/supplementalSemanticId |New attribute
|  |Identifiable/id |Substitute for Identifiable/identification
|  |xref:page$IDTA-01001_Metamodel_Referencing.adoc#KeyTypes[KeyTypes] |Before: KeyElements +
 +
...
|  |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#LabelType[LabelType] |New string type with maximum 64 characters
|  |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
| |xref:page$IDTA-01001_Metamodel_Core.adoc#ModellingKind[ModellingKind] |Renamed enumeration, before: ModelingKind
|  |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] |Substitute for LangStringSet with short multi-language strings, maximum 64 characters
|  |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |Substitute for LangStringSet with long multi-language strings, maximum 64 characters
|  |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#NameType[NameType] |New string type with maximum 128 characters
|  |Qualifier/kind |New experimental attribute for Qualifier
|  |xref:page$IDTA-01001_Metamodel_Common.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
...
|  |xref:page$IDTA-01001_Metamodel_Referencing.adoc#ReferenceTypes[ReferenceTypes] |New enumeration for Reference/type
|  |ReferenceTypes/ExternalReference |Enumeration value, was named GlobalReference before
|  |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#Resource[Resource] |new type for AssetInformation/defaultThumbnail
|  |ShortNameType |New string type with maximum 64 characters
|  |xref:page$IDTA-01001_Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |New type for AssetInformation/specificAssetId
...
|  |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |New experimental enumeration for BasicEventElement
|  |SubmodelElementElements |Enumeration for submodel elements (split of ReferableElements)
|  |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and collections
...
| |xref:page$IDTA-01001_Metamodel_Core.adoc#AdministrativeInformation[AdministrativeInformation] |Stereotype \<<dataType>> removed
...
| |AssetKind/Type |Updated description of value "Type" of enumeration "AssetKind" conformant to IEC 63278-1
| |AssetKind/Instance |Updated description of value "Instance" of enumeration "AssetKind" - conformant to IEC 63278-1
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] |Set to \<<Experimental>>
...
|(x)footnote:[Derived Schemata used Base64Binary and not hexBinary, therefore this change is considered to be backward compatible for most applications.] |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#BlobType[BlobType] |Primitive changed from "group of bytes" to Base64Binary
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#ContentType[ContentType] |Maximum length defined: 100 characters
...
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#Direction[Direction] |Set to \<<Experimental>>
...
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#EventElement[EventElement] |Set to \<<Experimental>>
| |EventElement/duration |Type changed from dateTimeStamp to dateTime
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] |Set to \<<Experimental>>
...
|x |HasKind/kind |Type changed from ModelingKind to ModellingKind
|x |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#Identifier[Identifier] |Maximum length defined: 2,000 characters
...
|x |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#PathType[PathType] |Same as Identifier; length constraint added
| |PrimitiveTypes |Removed
| |Qualifier/kind |Set to \<<Experimental>>
|x |xref:page$IDTA-01001_Metamodel_Common.adoc#QualifierType[QualifierType] |Type changed from string to NameType; length constraint added
...
|x |ReferenceTypes/GlobalReference |Renamed to ExternalReference
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#Resource[Resource] |Stereotype \<<DataType>> removed.
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |Set to \<<Experimental>>
...
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#LabelType[LabelType] |New string type with maximum 64 characters
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
| |xref:page$IDTA-01001_Metamodel_Common.adoc#ModellingKind[ModellingKind] |Renamed enumeration, before: ModelingKind
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] |Substitute for LangStringSet with short multi-language strings, maximum 64 characters
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |Substitute for LangStringSet with long multi-language strings, maximum 64 characters
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#NameType[NameType] |New string type with maximum 128 characters
| |ReferenceTypes/ExternalReference |Enumeration value: before: GlobalReference
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#RevisionType[RevisionType] |New type for _AdministrativeInformation/version_ with length constraints and regular expression
| |ShortNameType |New string type with maximum 64 characters
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#VersionType[VersionType] |New type for _AdministrativeInformation/revision_ with length constraints and regular expression
|===
...
<<<<<<< HEAD:documentation/IDTA-01001/modules/ROOT/pages/IDTA-01001_ChangeLog.adoc
| |xref:page$IDTA-01001_Metamodel_Common.adoc#AdministrativeInformation[AdministrativeInformation] |Bugfix: Stereotype "DataType" added
=======
...
<<<<<<< HEAD:documentation/IDTA-01001/modules/ROOT/pages/IDTA-01001_ChangeLog.adoc
| |xref:page$IDTA-01001_Metamodel_Referencing.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
=======
...
| |xref:page$IDTA-01001_Metamodel_Core.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset, because not specific to Asset but to AAS
| |AssetInformation/assetKind |Former Asset/assetKind
| |AssetInformation/globalAssetId |Former Asset/identification/id
| |AssetInformation/specificAssetId |Former Asset/assetIdentificationModel
| |AssetInformation/thumbnail |Optional Attribute of new class AssetInformation that was not available in Asset class before
...
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#EventElement[EventElement] |Former name: Event
<<<<<<< HEAD:documentation/IDTA-01001/modules/ROOT/pages/IDTA-01001_ChangeLog.adoc
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] |New class for event payload
=======
...
| |EventPayload/subjectId |Was part of non-normative part before
| |EventPayload/timestamp |Was part of non-normative part before
| |xref:page$IDTA-01001_Metamodel_Common.adoc#Extension[Extension] |New class, part of new abstract class HasExtensions
| |xref:page$IDTA-01001_Metamodel_Referencing.adoc#FragmentKeys[FragmentKeys] |New enumeration used for References
| |xref:page$IDTA-01001_Metamodel_Referencing.adoc#GenericFragmentKeys[GenericFragmentKeys] |New enumeration used for References
| |GenericGloballyIdentifiers |New enumeration used for References
| |xref:page$IDTA-01001_Metamodel_Referencing.adoc#GloballyIdentifiables[GloballyIdentifiables] |New enumeration used for References
...
| |xref:page$IDTA-01001_Metamodel_Referencing.adoc#ReferenceTypes[ReferenceTypes] |New enumeration for Reference/type
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |New enumeration for BasicEventElement
| |xref:page$IDTA-01001_Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |New type for AssetInformation/specificAssetId
| |SpecificAssetId/name |New type for AssetInformation/specificAssetId
| |SpecificAssetId/value |New type for AssetInformation/specificAssetId
...
| |SubmodelElementElements |Enumeration for submodel elements (split of ReferableElements)
|  |xref:page$IDTA-01001_Metamodel.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and structs
| |SubmodelElementList/orderRelevant |Similar to SubmodelElementCollection/ordered
| |SubmodelElementList/value |Similar to SubmodelElementCollection/value but ordered and with all elements having the same semanticId
| |SubmodelElementList/semanticIdListElement |Attribute of new class SubmodelElementList
| |SubmodelElementList/typeValueListElement |Attribute of new class SubmodelElementList
...
| |xref:page$IDTA-01001_Metamodel_Common.adoc#AdministrativeInformation[AdministrativeInformation] |Bugfix: Stereotype "DataType" added
| |AnnotatedRelationship/annotation |Type changed from ModelReference<xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#DataElement[DataElement]> to DataElement
...
|x |Event |Renamed to EventElement
|x |Extension/refersTo |Type changed from Reference to ModelReference<xref:page$IDTA-01001_Metamodel_Common.adoc#Referable[Referable]>
...
| |Property/valueType |Type changed from DataTypeDef to DataTypeDefXsd
|x |Qualifiable/qualifier |Type changed from Constraint to Qualifier
| |xref:page$IDTA-01001_Metamodel_Common.adoc#Qualifier[Qualifier] |Does not inherit from abstract class "Constraint" any longer
| |Qualifier/valueType |Type changed from DataTypeDef to DataTypeDefXsd
| |Range/valueType |Type changed from DataTypeDef to DataTypeDefXsd
| |Referable/idShort |Now optional, was mandatory
|x |ReferableElements |Substituted with enumeration AasSubmodelElements and AasIdentifiables
...
| |RelationshipElement/first |Type changes from model reference Referable to Reference (global or model reference)
| |RelationshipElement/second |Type changes from model reference Referable to Reference (global or model reference)
| |xref:page$IDTA-01001_Metamodel.adoc#ValueDataType[ValueDataType] |Before as specified via DataTypeDef, now any xsd atomic type as specified via DataTypeDefXsd + Prefix xs: added to every value in list
...
| |xref:page$IDTA-01001_Metamodel_Referencing.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
| |xref:page$IDTA-01001_Metamodel_Referencing.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
| |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] |Former name: BasicEvent
...
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#ContentType[ContentType] |Former name: MimeType
| |xref:page$IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + prefix rdf: added to every value in enumeration
| |xref:page$IDTA-01001_Metamodel.adoc#DataTypeDefXsd[DataTypeDefXsd] |Enumeration consisting of enumerations decimalBuildInTypes, durationBuildInTypes, PrimitiveTypes that correspond to anySimpleTypes of xsd. + prefix xs: added to every value in enumeration
| |dateTimeStamp |New data type for metamodel as used in EventPayload
...
| |xref:page$IDTA-01001_Metamodel_Common.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
| |Referable/checksum |
| |xref:page$IDTA-01001_Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |Before: IdentifierKeyValuePair, was renamed
...
|  |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and structs
| |SubmodelElementList/orderRelevant |Similar to SubmodelElementCollection/ordered
| |SubmodelElementList/value |Similar to SubmodelElementCollection/value but ordered and with all elements having the same semanticId
...
| |xref:page$IDTA-01001_Metamodel_DataSpecifications.adoc#HasDataSpecification[HasDataSpecification] |Was abstract before
...
|x |xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#OperationVariable[OperationVariable] |No longer inherits from SubmodelElement
...
|===
|*V2.0* |*Comment*
|xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#AnnotatedRelationshipElement[AnnotatedRelationshipElement] |New submodel element, inheriting from RelationshipElement
|Asset/billOfMaterial |New attribute
|xref:page$IDTA-01001_Metamodel.adoc#AssetKind[AssetKind] |New enumeration type
|BasicEvent |New submodel element, inherits from Event
|xref:page$IDTA-01001_Metamodel.adoc#Capability[Capability] |New submodel element
...
|xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#Entity[Entity] |New submodel Element
|xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#EntityType[EntityType] |New enumeration type
...
|xref:page$IDTA-01001_Metamodel_DataTypes.adoc#LangStringSet[LangStringSet] |New type, used for example in MultiLanguageProperty
|LevelType |New enumeration type
|xref:page$IDTA-01001_Metamodel_Core.adoc#ModellingKind[ModellingKind] |New enumeration type
|xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#MultiLanguageProperty[MultiLanguageProperty] |New submodel element
|Qualifier/valueType |New attribute to be consistent with valueType of Property etc.
|xref:page$IDTA-01001_Metamodel_SubmodelElements.adoc#Range[Range] |New submodel element
...
|xref:page$IDTA-01001_Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |New type, used for example for Property value
|ValueList |New class
