...
* New logical enumerations "AasContainerSubmodelElements" and "AasNonContainerSubmodelElements"  (https://github.com/admin-shell-io/aas-specs/issues/420[#420])
...
* move chapter "General" to Annex
* remove Annex "Requirements"
...
* AASd-119 Class name is "HasKind", not "hasKind"


Minor Changes:


* add new data type "DateTimeUtc" and use it for attribute _lastUpdate_ of _BasicEventElement_ and attribute _timeStamp_ of _EventPayload_ (https://github.com/admin-shell-io/aas-specs/issues/498[#498])
* change recommendation for recursion: from "[..] maximum recursion depth of 32 [..]" to "A recursion depth of 32 should not be exceeded. The recommendation is to have not more than 8 recursions in a submodel. Test engines should test at least 16 recursions."
...
* remove notes or change notes to paragraphs in Annex "General"
...
* enhanced explanation for AASd-130
* change explanation of Entity/statement to singular for consistency
* remove [23] from bibliography and remove corresponding notes referring to it
