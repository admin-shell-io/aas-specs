...
| {empty} | xref:spec-metamodel/datatypes.adoc#PathType[PathType] a| extend data type to support complete URI scheme for files RFC2396
...
| {empty} | xref:spec-metamodel/submodel-elements.adoc#Resource[Resource/path] a| Type was extended, see PathType
|===
...
|x |xref:spec-metamodel/common.adoc#QualifierType[QualifierType] |Type changed from string to NameType (i.e. length constraint added)
...
|{empty} |xref:spec-metamodel/submodel-elements.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
| |xref:spec-metamodel/core.adoc#ModellingKind[ModellingKind] |Renamed enumeration, before: ModelingKind
...
|{empty} |xref:spec-metamodel/datatypes.adoc#Resource[Resource] |new type for AssetInformation/defaultThumbnail
...
| |xref:spec-metamodel/core.adoc#AdministrativeInformation[AdministrativeInformation] a|Stereotype \<<dataType>> removed
...
|x |xref:spec-metamodel/common.adoc#QualifierType[QualifierType] a|Type changed from string to NameType; length constraint added
...
| |xref:spec-metamodel/datatypes.adoc#Resource[Resource] a|Stereotype \<<DataType>> removed.
...
| |xref:spec-metamodel/submodel-elements.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
...
| |xref:data-specifications.adoc#HasDataSpecification[HasDataSpecification] |Was abstract before
...
|xref:spec-metamodel/core.adoc#ModellingKind[ModellingKind] |New enumeration type
