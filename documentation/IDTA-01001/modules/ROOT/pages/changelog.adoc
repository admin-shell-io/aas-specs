...
| {empty} | xref:spec-metamodel/SubmodelElements.adoc#File[File/value] a| Type was extended, see PathType
|(x) | xref:spec-metamodel/DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] a| (bugfix in Text only) maxLength=128 (as derived and implemented)
...
|(x)  | xref:spec-metamodel/Common.adoc#Qualifier[Qualifier/Kind] a| (bugfix in Text only) attribute starts with small letter
| {empty} | xref:spec-metamodel/SubmodelElements.adoc#Resource[Resource/path] a| Type was extended, see PathType
|===
