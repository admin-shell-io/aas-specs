...
* move Clause "Semantic Identifiers for Metamodel and Data Specifications" from main part to Annex
** no plural s any longer, i.e. only semantic identifiers for attributes and classes
