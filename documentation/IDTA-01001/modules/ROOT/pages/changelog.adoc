...
* CHANGED: Value-Only SChema adaptd to changes in classes Entity, RelationshipElement etc.
...
| {empty} | xref:spec-metamodel/datatypes.adoc#NameType[NameType] a| implicit change because constraint AASd-002 now also allows hyphen
