...
* CHANGE: move Clause "Semantic Identifiers for Metamodel and Data Specifications" from main part to Annex
...
Major Bugfixes:
- CHANGE: Environment does not inherit from  "Reference"
...
* CHANGE: support relative path for SubmodelElement File, PathType: support complete URI scheme for files RFC2396 conformant to anyURI of XML Schema 1.0, Part 2 (https://github.com/admin-shell-io/aas-specs/issues/299[#299])
...
* CHANGE: Update on handling AASd-130 for schemas different to xml and reformulation of Constraint AASd-130 (https://github.com/admin-shell-io/aas-specs/issues/362[#362])

* CHANGE (Editorial): updated Change Logs of V3.0 w.r.t. Range: Range was set to experimental in V3.0


* CHANGE (Editorial, the schemas implemented it like this) Annex UML Tables: "0..*" or "0..3" etc. means that the list may be either not available (optional) or the list is not empty. (https://github.com/admin-shell-io/aas-specs/issues/418[#418])

* CHANGE (Editorial, the schemas implemented it like this, table was correct) Update Figure containing Resource: Resource/path has cardinality 1 and Resource/contentType has cardinality 0..1 (https://github.com/admin-shell-io/aas-specs/issues/438[#438])
