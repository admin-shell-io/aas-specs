...
|xxref:Bibliography.adoc#bib1[[1\]] |SubmodelElement/kind |Removed. SubmodelElement no longer inheritsfrom HasKind
...
| |Extension/valueType |{empty}
|{empty} |File/contentType |Fromer File/mimeType
...
|{empty} |AssetAdministrationShell/view |Removed, views not longer supported
