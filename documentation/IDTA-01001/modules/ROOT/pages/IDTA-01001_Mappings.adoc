...
////
includes:
IDTA-01001_GrammarSerializationReference.adoc[leveloffset=-1]
IDTA-01001_MetaDataObjects.adoc[leveloffset=-1]
IDTA-01001_ValueOnly.adoc[leveloffset=-1]
IDTA-01001_idShortPath.adoc[leveloffset=-1]
////
...
====
Note 1: the xml schema (.xsd files) is maintained in the repository "aas-specs" of the github project admin-shell-io xref:IDTA-01xxx_Bibliography.adoc#bib51[[51\]]: aas-specs-3.0\schemas\xml
====
...
====
Note 1: the JSON schema (.json files) is maintained in the repository "aas-specs" of the github project admin-shell-io xref:IDTA-01xxx_Bibliography.adoc#bib51[[51\]]: aas-specs-3.0\schemas\json
====
...
====
Note 1: the RDF scheme/OWL files (.ttl files) are maintained in the repository "aas-specs" of the github project admin-shell-io xref:IDTA-01xxx_Bibliography.adoc#bib51[[51\]]: aas-specs-3.0\schemas\rdf
====
