...
* Referable/idShort and Constraint AASd-002: now also allows hyphens to be included in name [#295](https://github.com/admin-shell-io/aas-specs/issues/295)
...
[#]307(https://github.com/admin-shell-io/aas-specs/issues/307)
...
|file:///C:/__localWork/Asset%20Administration%20Shell%20-%20Verwaltungsschale/Verwaltungsschale%20im%20Detail%20-%20part%201a%20V3.0/Change%202.0%20-%203.0.xlsx#RANGE!#REF![(x)link:#bib2[[2\]]] |xref:xref:page$IDTA-01001_Metamodel.adoc#BlobType[BlobType |Primitive changed from "group of bytes" to Base64Binary
|X |ConceptDictionary |Removed
|X |Constraint |Abstract class removed. Formula now used in Security part only
|x |xref:xref:page$IDTA-01001_DataSpecifications.doc#DataSpecification[DataSpecification] |No longer inherits from Identifiable. However, same attribute names and types
|x |DataSpecification/description |Type changed from LangStringSet to MultiLanguageTextType, thus adding a length constraint
| |xref:xref:page$IDTA-01001_DataSpecifications.adoc#DataSpecificationContent[DataSpecificationContent] |Stereotype \<<Template>> added
...
|x |xref:xref:page$IDTA-01001_Metamodel.adoc#Identifier[Identifier] a|
Type changed
...
|x |xref:xref:page$IDTA-01001_Metamodel.adoc#PathType[PathType] |Same as Identifier, i.e. length constraint added
...
|  |xref:xref:page$IDTA-01001_Metamodel.adoc#Qualifier[Qualifier] |No longer inherits from abstract class "Constraint"
|  |Qualifier/valueType |Type changed from DataTypeDef to DataTypeDefXsd
|x |xref:xref:page$IDTA-01001_Metamodel.adoc#QualifierType[QualifierType] |Type changed from string to NameType (i.e. length constraint added)
...
|  |xref:xref:page$IDTA-01001_Metamodel.adoc#ValueDataType[ValueDataType] |Before as specified via DataTypeDef, now any xsd atomic type as specified via DataTypeDefXsd
| x |View |Removed
|===
...
|===
| |*New Elements V3.0 vs V2.0.1* |*Comment*
|  |xref:xref:page$IDTA-01001_Metamodel.adoc#AasIdentifiables[AasIdentifiables] |New enumeration used for References, includes abstract Identifiable +
 +
Before: Identifiables
|  |xref:xref:page$IDTA-01001_Metamodel.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
|  |xref:xref:page$IDTA-01001_Metamodel.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
|  |xref:xref:page$IDTA-01001_Metamodel.adoc#AasSubmodelElements[AasSubmodelElements] |New enumeration used for References +
 +
...
|  |xref:xref:page$IDTA-01001_Metamodel.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset because not specific to Asset but AAS
...
|  |xref:xref:page$IDTA-01001_Metamodel.adoc#BasicEventElement[BasicEventElement] |Former BasicEvent +
 +
...
|  |xref:xref:page$IDTA-01001_Metamodel.adoc#ContentType[ContentType] |Former name: MimeType +
Maximum length defined: 100 characters
|  |xref:page$IDTA-01001_Metamodel.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + added prefix rdf: to every value in enumeration
|  |xref:page$IDTA-01001_Metamodel.adoc#DataTypeDefXsd[DataTypeDefXsd] |Enumeration that corresponds to anySimpleTypes of XML Schema 1.0 +
 +
...
Set to \<<Experimental>>
|  |xref:page$IDTA-01001_Metamodel.adoc#EventPayload[EventPayload] |New experimental class for event payload +
...
|  |xref:page$IDTA-01001_Metamodel.adoc#FragmentKeys[FragmentKeys] |New enumeration used for References
|  |xref:page$IDTA-01001_Metamodel.adoc#GenericFragmentKeys[GenericFragmentKeys] |New enumeration used for References
|  |GenericGloballyIdentifiers |New enumeration used for References
|  |xref:page$IDTA-01001_Metamodel.adoc#GloballyIdentifiables[GloballyIdentifiables] |New enumeration used for References
|  |xref:page$IDTA-01001_Metamodel.adoc#HasExtensions[HasExtensions] |New abstract class, inherited by Referable
|  |HasSemantics/supplementalSemanticId |New attribute
|  |Identifiable/id |Substitute for Identifiable/identification
|  |xref:page$IDTA-01001_Metamodel.adoc#KeyTypes[KeyTypes] |Before: KeyElements +
 +
...
|  |xref:page$IDTA-01001_Metamodel.adoc#LabelType[LabelType] |New string type with maximum 64 characters
|  |xref:page$IDTA-01001_Metamodel.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
| |xref:page$IDTA-01001_Metamodel.adoc#ModellingKind[ModellingKind] |Renamed enumeration, before: ModelingKind
|  |xref:page$IDTA-01001_Metamodel.adoc#MultiLanguageNameType[MultiLanguageNameType] |Substitute for LangStringSet with short multi-language strings, maximum 64 characters
|  |xref:page$IDTA-01001_Metamodel.adoc#MultiLanguageTextType[MultiLanguageTextType] |Substitute for LangStringSet with long multi-language strings, maximum 64 characters
|  |xref:page$IDTA-01001_Metamodel.adoc#NameType[NameType] |New string type with maximum 128 characters
|  |Qualifier/kind |New experimental attribute for Qualifier
|  |xref:page$IDTA-01001_Metamodel.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
...
|  |xref:page$IDTA-01001_Metamodel.adoc#ReferenceTypes[ReferenceTypes] |New enumeration for Reference/type
|  |ReferenceTypes/ExternalReference |Enumeration value, was named GlobalReference before
|  |xref:page$IDTA-01001_Metamodel.adoc#Resource[Resource] |new type for AssetInformation/defaultThumbnail
|  |ShortNameType |New string type with maximum 64 characters
|  |xref:page$IDTA-01001_Metamodel.adoc#SpecificAssetId[SpecificAssetId] |New type for AssetInformation/specificAssetId
...
|  |xref:page$IDTA-01001_Metamodel.adoc#StateOfEvent[StateOfEvent] |New experimental enumeration for BasicEventElement
|  |SubmodelElementElements |Enumeration for submodel elements (split of ReferableElements)
|  |xref:page$IDTA-01001_Metamodel.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and collections
...
| |xref:page$IDTA-01001_Metamodel.adoc#AdministrativeInformation[AdministrativeInformation] |Stereotype \<<dataType>> removed
...
| |AssetKind/Type |Updated description of value "Type" of enumeration "AssetKind" conformant to IEC 63278-1
| |AssetKind/Instance |Updated description of value "Instance" of enumeration "AssetKind" - conformant to IEC 63278-1
| |xref:page$IDTA-01001_Metamodel.adoc#BasicEventElement[BasicEventElement] |Set to \<<Experimental>>
...
|(x)footnote:[Derived Schemata used Base64Binary and not hexBinary, therefore this change is considered to be backward compatible for most applications.] |xref:page$IDTA-01001_Metamodel.adoc#BlobType[BlobType] |Primitive changed from "group of bytes" to Base64Binary
| |xref:page$IDTA-01001_Metamodel.adoc#ContentType[ContentType] |Maximum length defined: 100 characters
...
| |xref:page$IDTA-01001_Metamodel.adoc#Direction[Direction] |Set to \<<Experimental>>
...
| |xref:page$IDTA-01001_Metamodel.adoc#EventElement[EventElement] |Set to \<<Experimental>>
| |EventElement/duration |Type changed from dateTimeStamp to dateTime
| |xref:page$IDTA-01001_Metamodel.adoc#EventPayload[EventPayload] |Set to \<<Experimental>>
...
|x |HasKind/kind |Type changed from ModelingKind to ModellingKind
|x |xref:page$IDTA-01001_Metamodel.adoc#Identifier[Identifier] |Maximum length defined: 2,000 characters
...
|x |xref:page$IDTA-01001_Metamodel.adoc#PathType[PathType] |Same as Identifier; length constraint added
| |PrimitiveTypes |Removed
| |Qualifier/kind |Set to \<<Experimental>>
|x |xref:page$IDTA-01001_Metamodel.adoc#QualifierType[QualifierType] |Type changed from string to NameType; length constraint added
...
|x |ReferenceTypes/GlobalReference |Renamed to ExternalReference
| |xref:page$IDTA-01001_Metamodel.adoc#Resource[Resource] |Stereotype \<<DataType>> removed.
| |xref:page$IDTA-01001_Metamodel.adoc#StateOfEvent[StateOfEvent] |Set to \<<Experimental>>
...
| |xref:page$IDTA-01001_Metamodel.adoc#RevisionType[RevisionType] |New type for _AdministrativeInformation/version_ with length constraints and regular expression
| |ShortNameType |New string type with maximum 64 characters
| |xref:page$IDTA-01001_Metamodel.adoc#VersionType[VersionType] |New type for _AdministrativeInformation/revision_ with length constraints and regular expression
|===
...
| |xref:page$IDTA-01001_Metamodel.adoc#ReferenceTypes[ReferenceTypes] |New enumeration for Reference/type
| |xref:page$IDTA-01001_Metamodel.adoc#StateOfEvent[StateOfEvent] |New enumeration for BasicEventElement
| |xref:page$IDTA-01001_Metamodel.adoc#SpecificAssetId[SpecificAssetId] |New type for AssetInformation/specificAssetId
| |SpecificAssetId/name |New type for AssetInformation/specificAssetId
| |SpecificAssetId/value |New type for AssetInformation/specificAssetId
...
|===
|*nc* |*V3.0RC02 Change w.r.t. V2.0.1* |*Comment*
| |xref:page$IDTA-01001_Metamodel.adoc#DataSpecification[DataSpecification] a|
...
| |xref:page$IDTA-01001_Metamodel.adoc#DataSpecificationContent[DataSpecificationContent] |Stereotype \<<Template>> added
...
| |xref:page$IDTA-01001_Metamodel.adoc#AdministrativeInformation[AdministrativeInformation] |Bugfix: Stereotype "DataType" added
| |AnnotatedRelationship/annotation |Type changed from ModelReference<xref:page$IDTA-01001_Metamodel.adoc#DataElement[DataElement]> to DataElement
...
|x |Event |Renamed to EventElement
|x |Extension/refersTo |Type changed from Reference to ModelReference<xref:page$IDTA-01001_Metamodel.adoc#Referable[Referable]>
...
| |Property/valueType |Type changed from DataTypeDef to DataTypeDefXsd
|x |Qualifiable/qualifier |Type changed from Constraint to Qualifier
| |xref:page$IDTA-01001_Metamodel.adoc#Qualifier[Qualifier] |Does not inherit from abstract class "Constraint" any longer
| |Qualifier/valueType |Type changed from DataTypeDef to DataTypeDefXsd
| |Range/valueType |Type changed from DataTypeDef to DataTypeDefXsd
| |Referable/idShort |Now optional, was mandatory
|x |ReferableElements |Substituted with enumeration AasSubmodelElements and AasIdentifiables
...
| |xref:page$IDTA-01001_Metamodel.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
| |xref:page$IDTA-01001_Metamodel.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
| |xref:page$IDTA-01001_Metamodel.adoc#BasicEventElement[BasicEventElement] |Former name: BasicEvent
...
| |xref:page$IDTA-01001_Metamodel.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
| |Referable/checksum |
| |xref:page$IDTA-01001_Metamodel.adoc#SpecificAssetId[SpecificAssetId] |Before: IdentifierKeyValuePair, was renamed
...
|x |AssetAdministrationShell/assetInformation |Substitute for AssetAdministrationShell/asset (no reference any longer, instead aggregation)
| |xref:page$IDTA-01001_Metamodel.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset because not specific to Asset but AAS
| |AssetInformation/thumbnail |Optional Attribute of new class AssetInformation that was not available in Asset class before
...
| |xref:page$IDTA-01001_Metamodel.adoc#DataSpecification[DataSpecification] |Bugfix, is not abstract
...
| |xref:page$IDTA-01001_Metamodel.adoc#HasDataSpecification[HasDataSpecification] |Was abstract before
...
|x |xref:page$IDTA-01001_Metamodel.adoc#OperationVariable[OperationVariable] |No longer inherits from SubmodelElement
...
|===
|*V2.0* |*Comment*
|xref:page$IDTA-01001_Metamodel.adoc#AnnotatedRelationshipElement[AnnotatedRelationshipElement] |New submodel element, inheriting from RelationshipElement
...
|xref:page$IDTA-01001_Metamodel.adoc#Entity[Entity] |New submodel Element
|xref:page$IDTA-01001_Metamodel.adoc#EntityType[EntityType] |New enumeration type
...
|xref:page$IDTA-01001_Metamodel.adoc#LangStringSet[LangStringSet] |New type, used for example in MultiLanguageProperty
|LevelType |New enumeration type
|xref:page$IDTA-01001_Metamodel.adoc#ModellingKind[ModellingKind] |New enumeration type
|xref:page$IDTA-01001_Metamodel.adoc#MultiLanguageProperty[MultiLanguageProperty] |New submodel element
|Qualifier/valueType |New attribute to be consistent with valueType of Property etc.
|xref:page$IDTA-01001_Metamodel.adoc#Range[Range] |New submodel element
...
|xref:page$IDTA-01001_Metamodel.adoc#ValueDataType[ValueDataType] |New type, used for example for Property value
|ValueList |New class
