...
* (Editorial) HasKind/kind explanataroy text: use template, not type (https://github.com/admin-shell-io/aas-specs/issues/313[#313])
...
|x |xref:page$IDTA-01001_Metamodel.adoc#PathType[PathType] |Same as Identifier, i.e. length constraint added
...
|x |xref:page$IDTA-01001_Metamodel.adoc#QualifierType[QualifierType] |Type changed from string to NameType (i.e. length constraint added)
...
|  |xref:page$IDTA-01001_Metamodel.adoc#BasicEventElement[BasicEventElement] |Former BasicEvent +
 +
