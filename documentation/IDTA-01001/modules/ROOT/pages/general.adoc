...
<<table-life-cycle-phases-and-roles-of-type-and-instance-asses>> gives an overview of the different life cycle pases and the role of type assets and instance assets as well as their relationship in these phases.
...
[[table-life-cycle-phasesand-roles-of-type-and-instance-assets]]
[cols="20%,22%,58%",optio=header]
|===
...
====
Note: the NIST model xref:biliography.adoc#bib49[[49\]] provides an illustration of the second/third class of relationships.
====
...
The Plattform Industrie 4.0 metamodel for Asset Administration Shells is defined in Clause xref:spec-metamodel/index.adoc#part1-specification[Specification].
