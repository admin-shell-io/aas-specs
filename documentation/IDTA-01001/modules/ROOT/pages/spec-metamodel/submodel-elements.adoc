...
For information on content type, see Clause xref:spec-metamodel/submodel-elements.adoc#_file_attributes[File Attributes].
...
Matching strategies for semantic IDs are explained in Clause xref:general.adoc#_matching_strategies_for_semantic_identifiers[Matching Strategies for Semantic Identifiers].
