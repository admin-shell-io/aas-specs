...
For matching algorithm, see Clause xref:annex/general.adoc#matching-strategies-for-semantic-identifiers[Matching Strategies for Semantic Identifiers].
...
Information about identification can be found in Clause xref:annex/general.adoc#identification-of-elements[Identification of Elements].
See Clause xref:annex/general.adoc#which-identifiers-for-which-elements[Which Identifiers for Which Elements?] for constraints and recommendations on when to use which type of identifier.

See Clause xref:annex/general.adoc#which-identifiers-for-which-elements[Which Identifiers for Which Elements?] for information about which identifier types are supported.
