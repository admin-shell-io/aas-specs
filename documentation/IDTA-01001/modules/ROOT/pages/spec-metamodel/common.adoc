...
xref:spec-metamodel/common.adoc#AdministrativeInformation[AdministrativeInformation] allows the usage of templates (xref:spec-metamodel/common.adoc#HasDataSpecification[HasDataSpecification]). Data specifications are defined in separate documents.
...
For matching algorithm, see Clause xref:general.adoc#_matching_strategies_for_semantic_identifiers[Matching Strategies for Semantic Identifiers].
...
Information about identification can be found in Clause xref:general.adoc#identification-of-elements[Identification of Elements].See Clause xref:general.adoc#_which_identifiers_for_which_elements[Which Identifiers for Which Elements?] for constraints and recommendations on when to use which type of identifier.

See Clause xref:general.adoc#_which_identifiers_for_which_elements[Which Identifiers for Which Elements?] for information about which identifier types are supported.
...
====
Note: see Clause xref:spec-metamodel/constraints.adoc#_constraints_for_qualifiers[Constraints for Qualifiers] for constraints related to qualifiables.
====
...
====
Note 2: see Clause xref:spec-metamodel/constraints.adoc#_constraints_for_referables_and_identifiables[Constraints for Referables and Identifiables] for constraints related to referables.
====
