...
Adding a _semanticId_ for a submodel is recommended (see xref:general.adoc#table-elements-with-allowed-identifying-values[Table "Elements with Allowed Identifying Values"]).
