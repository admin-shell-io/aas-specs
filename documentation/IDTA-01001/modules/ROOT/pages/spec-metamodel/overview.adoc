...
See Clause xref:spec-metamodel/submodel-elements.adoc[] for details.
...
See Clause xref:data-specifications.adoc[] for details.
...
<<image-metamodel-package-overview>> gives a complete overview of all elements defined in the metamodel and specified in Clause xref:spec-metamodel/nav-spec.adoc[].
