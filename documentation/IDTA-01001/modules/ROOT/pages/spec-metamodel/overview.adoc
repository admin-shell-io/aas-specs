...
For details on identification, see Clause xref:annex/general.adoc#identification-of-elements[Identification of Elements].
...
See Clause xref:annex/general.adoc#matching-strategies[Matching Strategies] for matching strategies.
