...
<<image-metamodel-package-overview>> gives a complete overview of all elements defined in the metamodel and specified in Clause xref:spec-metamodel/index.adoc[].
