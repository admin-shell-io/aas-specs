...
====
Note: xref:referencing.adoc#constraint-AASd-125[Constraint AASd-125] ensures that the shortest path is used.
====
...
Key type "Submodel" is not a globally identifiable (see xref:referencing.adoc#constraint-AASd-121[Constraint AASd-121]).
...
Key type "Submodel" is no generic globally identifiable (see xref:referencing.adoc#constraint-AASd-122[Constraint AASd-122]).
...
Key type "GlobalReference" is no AAS identifiable (see xref:referencing.adoc#constraint-AASd-123[Constraint AASd-123]). 
The last key type "GlobalReference" is neither a generic globally identifiable nor a generic fragment key (see xref:referencing.adoc#constraint-AASd-124[Constraint AASd-124]).
...
This reference does not start with the ID of an Identifiable, i.e. key type "Property" is no AAS identifiable (see xref:referencing.adoc#constraint-AASd-123[Constraint AASd-123]).
...
Key "Property" is no generic fragment key and therefore fragment key "FragmentReference" is not allowed before (see xref:referencing.adoc#constraint-AASd-126[Constraint- AASd-126]).
...
This model reference is invalid because fragment references so far are only defined for "File" and "Blob" submodel elements (see xref:referencing.adoc#constraint-AASd-127[Constraint AASd-127]).
...
This is not a valid model reference because key type "AssetAdministrationShell"  and "Submodel" are both global identifiables and there shall be only one (see Constraints xref:referencing.adoc#constraint-AASd-125[Constraint AASd-125]).
