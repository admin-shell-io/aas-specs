...
include::encondings/grammar-serialization-reference.adoc[]

include::encondings/embedded-data-specifications.adoc[]

include::encondings/metadata-objects.adoc[]

include::encondings/valueonly.adoc[]

include::encondings/valueonly-json-schema.adoc[]

include::encondings/idshortpath.adoc[]
