...
| {empty} | xref:Spec/Metamodel_Core.adoc#AssetKind[AssetKind] a| Add new value "Role" to enumeration AssetKind
| {empty} | xref:Spec/Metamodel_SubmodelElements.adoc#Entity[Entity/entityType] a| now optional
| {empty} | xref:Spec/Metamodel_DataTypes.adoc#Identifier[Identifier] a| data type: change length from 2000 to 2024 characters
| {empty} | xref:Spec/Metamodel_DataTypes.adoc#NameType[NameType] a| implicit change due to change of Constraint AASd-002
| {empty} | xref:Spec/Metamodel_DataTypes.adoc#PathType[PathType] a| extend data type to support complete URI scheme for files RFC2396
|{empty}  | xref:Spec/Metamodel_Common.adoc#Referable[Referable/idShort] a| implicit change because constraint AASd-002 now also allows hyphen
| {empty} | xref:Spec/Metamodel_SubmodelElements.adoc#RelationshipElement[RelationshipElement/first] a| now optional
| {empty} | xref:Spec/Metamodel_SubmodelElements.adoc#RelationshipElement[RelationshipElement/second] a| now optional
...
|===
|{empty} |*New Elements V3.1 vs V3.0* |*Comment*
|{empty} | xref:Spec/Metamodel_Core.adoc#AssetKind[AssetKind/Role] | New value in enumeration
|===
...
|===
|*Nc* |*V3.1 Change w.r.t. V3.0* |*Comment*
|(x)| xref:Spec/Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement/Direction] a| (bugfix in Text only) attribute starts with small letter
|(x) | xref:Spec/Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement/State] a|  (bugfix in Text only) attribute starts with small letter
|x| xref:Spec/Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd] a| BUGFIX: Remove xs:yearMonthDuration from enumeration

Updated links to XML Schema 1.0 (not 1.1)
|(x)| EmbeddedDataSpecification/dataSpecification a| (bugfix in Text only) now mandatory
|(x) | xref:Spec/Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] a| (bugfix in Text only) maxLength=128 (as derived and implemented)
|(x)  | xref:Spec/Metamodel_Common.adoc#Qualifier[Qualifier/Kind] a| (bugfix in Text only) attribute starts with small letter
| {empty} | xref:Spec/Metamodel_SubmodelElements.adoc#File[File/value] a| Type was extended, see PathType
|(x) | xref:Spec/Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] a| (bugfix in Text only) maxLength=128 (as derived and implemented)
| {empty} | xref:Spec/Metamodel_DataTypes.adoc#PathType[PathType] a| string instead of Identifier but with same length constraints

extend data type to support complete URI scheme for files RFC2396
|(x)  | xref:Spec/Metamodel_Common.adoc#Qualifier[Qualifier/Kind] a| (bugfix in Text only) attribute starts with small letter
| {empty} | xref:Spec/Metamodel_SubmodelElements.adoc#Resource[Resource/path] a| Type was extended, see PathType
|===
...
|{empty} |xref:Spec/Metamodel_Core.adoc#AssetKind[AssetKind/Instance] |Updated description of value "Instance" of enumeration "AssetKind" conformant to IEC 63278-1
|{empty} |xref:Spec/Metamodel_Core.adoc#AssetKind[AssetKind/Type] |Updated description of value "Type" of enumeration "AssetKind" conformant to IEC 63278-1
|x |xref:Spec/Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEvent] |Renamed to BasicEventElement and set to \<<Experimental>>

|xxref:Bibliography.adoc#bib2[[2\]] |xref:Spec/Metamodel_DataTypes.adoc#BlobType[BlobType] |Primitive changed from "group of bytes" to Base64Binary

|x |ConceptDictionary |Removed
|x |Constraint |Abstract class removed. Formula now used in Security part only
|x |xref:DataSpecifications.adoc#DataSpecification[DataSpecification] |No longer inherits from Identifiable. However, same attribute names and types
|x |DataSpecification/description |Type changed from LangStringSet to MultiLanguageTextType, thus adding a length constraint
| |xref:DataSpecifications.adoc#DataSpecificationContent[DataSpecificationContent] |Stereotype \<<Template>> added
...
|x |xref:Spec/Metamodel_DataTypes.adoc#Identifier[Identifier] a|
Type changed
...
|x |xref:Spec/Metamodel_DataTypes.adoc#PathType[PathType] |Same as Identifier, i.e. length constraint added
...
|{empty} |xref:Spec/Metamodel_Common.adoc#Qualifier[Qualifier] |No longer inherits from abstract class "Constraint"
|{empty} |Qualifier/valueType |Type changed from DataTypeDef to DataTypeDefXsd
|x |xref:Spec/Metamodel_Common.adoc#QualifierType[QualifierType] |Type changed from string to NameType (i.e. length constraint added)
| |xref:Spec/Metamodel_SubmodelElements.adoc#Range[Range] | set to \<<Experimental>>
|{empty} |xref:Spec/Metamodel_SubmodelElements.adoc#Range[Range/valueType] |Type changed from DataTypeDef to DataTypeDefXsd
...
|{empty} |xref:Spec/Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |Before as specified via DataTypeDef, now any xsd atomic type as specified via DataTypeDefXsd
...
|{empty} |xref:Spec/Metamodel_Referencing.adoc#AasIdentifiables[AasIdentifiables] |New enumeration used for References, includes abstract Identifiable +
 +
Before: Identifiables
|{empty} |xref:Spec/Metamodel_Referencing.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
|{empty} |xref:Spec/Metamodel_Referencing.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
|{empty} |xref:Spec/Metamodel_Referencing.adoc#AasSubmodelElements[AasSubmodelElements] |New enumeration used for References +
 +
...
|{empty} |xref:Spec/Metamodel_Core.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset because not specific to Asset but AAS
...
|{empty} |xref:Spec/Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] |Former BasicEvent +
 +
...
|{empty} |xref:Spec/Metamodel_DataTypes.adoc#ContentType[ContentType] |Former name: MimeType +
Maximum length defined: 100 characters
|{empty} |xref:Spec/Metamodel_DataTypes.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + added prefix rdf: to every value in enumeration
|{empty} |xref:Spec/Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd] |Enumeration that corresponds to anySimpleTypes of XML Schema 1.0 +
 +
...
|{empty} |xref:Spec/Metamodel_SubmodelElements.adoc#Direction[Direction] |New Enumeration for BasicEventElement
...
|{empty} |xref:Spec/Metamodel_Environment.adoc#Environment[Environment] |New class for entry point for Asset Administration Shells, submodels and concept descriptions.
|{empty} |xref:Spec/Metamodel_SubmodelElements.adoc#EventElement[EventElement] |Former name: Event +
Set to \<<Experimental>>
|{empty} |xref:Spec/Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] |New experimental class for event payload +
...
|{empty} |xref:Spec/Metamodel_Common.adoc#Extension[Extension] |New class, part of new abstract class HasExtensions
| |Extension/name |{empty}
| |Extension/refersTo |{empty}
| |Extension/valueType |{empty}
| |Extension/valueType |{empty}
|{empty} |File/contentType |Fromer File/mimeType
|{empty} |xref:Spec/Metamodel_Referencing.adoc#FragmentKeys[FragmentKeys] |New enumeration used for References
|{empty} |xref:Spec/Metamodel_Referencing.adoc#GenericFragmentKeys[GenericFragmentKeys] |New enumeration used for References
|{empty} |GenericGloballyIdentifiers |New enumeration used for References
|{empty} |xref:Spec/Metamodel_Referencing.adoc#GloballyIdentifiables[GloballyIdentifiables] |New enumeration used for References
|{empty} |xref:Spec/Metamodel_Common.adoc#HasExtensions[HasExtensions] |New abstract class, inherited by Referable
|{empty} |HasSemantics/supplementalSemanticId |New attribute
|{empty} |Identifiable/id |Substitute for Identifiable/identification
|{empty} |xref:Spec/Metamodel_Referencing.adoc#KeyTypes[KeyTypes] |Before: KeyElements +
 +
...
|{empty} |xref:Spec/Metamodel_DataTypes.adoc#LabelType[LabelType] |New string type with maximum 64 characters
|{empty} |xref:Spec/Metamodel_SubmodelElements.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
| |xref:Spec/Metamodel_Core.adoc#ModellingKind[ModellingKind] |Renamed enumeration, before: ModelingKind
|{empty} |xref:Spec/Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] |Substitute for LangStringSet with short multi-language strings, maximum 64 characters
|{empty} |xref:Spec/Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |Substitute for LangStringSet with long multi-language strings, maximum 64 characters
|{empty} |xref:Spec/Metamodel_DataTypes.adoc#NameType[NameType] |New string type with maximum 128 characters
|{empty} |Qualifier/kind |New experimental attribute for Qualifier
|{empty} |xref:Spec/Metamodel_Common.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
...
|{empty} |xref:Spec/Metamodel_Referencing.adoc#ReferenceTypes[ReferenceTypes] |New enumeration for Reference/type
|{empty} |ReferenceTypes/ExternalReference |Enumeration value, was named GlobalReference before
|{empty} |xref:Spec/Metamodel_DataTypes.adoc#Resource[Resource] |new type for AssetInformation/defaultThumbnail
|{empty} |ShortNameType |New string type with maximum 64 characters
|{empty} |xref:Spec/Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |New type for AssetInformation/specificAssetId
...
|{empty} |xref:Spec/Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |New experimental enumeration for BasicEventElement
|{empty} |SubmodelElementElements |Enumeration for submodel elements (split of ReferableElements)
|{empty} |xref:Spec/Metamodel_SubmodelElements.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and collections
...
| |xref:Spec/Metamodel_Core.adoc#AdministrativeInformation[AdministrativeInformation] a|Stereotype \<<dataType>> removed
...
| |xref:Spec/Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] a|Set to \<<Experimental>>
...
|(x)footnote:[Derived Schemata used Base64Binary and not hexBinary, therefore this change is considered to be backward compatible for most applications.] a|xref:Spec/Metamodel_DataTypes.adoc#BlobType[BlobType] |Primitive changed from "group of bytes" to Base64Binary
| |xref:Spec/Metamodel_DataTypes.adoc#ContentType[ContentType] a|Maximum length defined: 100 characters
...
| |xref:Spec/Metamodel_SubmodelElements.adoc#Direction[Direction] a|Set to \<<Experimental>>
...
| |xref:Spec/Metamodel_SubmodelElements.adoc#EventElement[EventElement] a|Set to \<<Experimental>>
| |EventElement/duration a|Type changed from dateTimeStamp to dateTime
| |xref:Spec/Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] a|Set to \<<Experimental>>
...
|x |xref:Spec/Metamodel_DataTypes.adoc#Identifier[Identifier] a|Maximum length defined: 2,000 characters
...
|x |xref:Spec/Metamodel_DataTypes.adoc#PathType[PathType] a|Same as Identifier; length constraint added
| |PrimitiveTypes |Removed
| |Qualifier/kind a|Set to \<<Experimental>>
|x |xref:Spec/Metamodel_Common.adoc#QualifierType[QualifierType] a|Type changed from string to NameType; length constraint added
...
| |xref:Spec/Metamodel_DataTypes.adoc#Resource[Resource] a|Stereotype \<<DataType>> removed.
| |xref:Spec/Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |Set to \<<Experimental>>
...
| |xref:Spec/Metamodel_DataTypes.adoc#LabelType[LabelType] |New string type with maximum 64 characters
| |xref:Spec/Metamodel_SubmodelElements.adoc#MessageTopicType[MessageTopicType] |New string type with maximum 255 characters
| |xref:Spec/Metamodel_Common.adoc#ModellingKind[ModellingKind] |Renamed enumeration, before: ModelingKind
| |xref:Spec/Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] |Substitute for LangStringSet with short multi-language strings, maximum 64 characters
| |xref:Spec/Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |Substitute for LangStringSet with long multi-language strings, maximum 64 characters
| |xref:Spec/Metamodel_DataTypes.adoc#NameType[NameType] |New string type with maximum 128 characters
| |ReferenceTypes/ExternalReference |Enumeration value: before: GlobalReference
| |xref:Spec/Metamodel_DataTypes.adoc#RevisionType[RevisionType] |New type for _AdministrativeInformation/revision_ with length constraints and regular expression
| |ShortNameType |New string type with maximum 64 characters
| |xref:Spec/Metamodel_DataTypes.adoc#VersionType[VersionType] |New type for _AdministrativeInformation/version_ with length constraints and regular expression
|===
...
| |xref:Spec/Metamodel_Common.adoc#AdministrativeInformation[AdministrativeInformation] |Bugfix: Stereotype "DataType" added

| |AnnotatedRelationship/annotation |Bugfix: Type changed from ModelReference<xref:Spec/Metamodel_SubmodelElements.adoc#DataElement[DataElement]> to DataElement
...
|x |Qualifiable/qualifier |Type changed from Constraint to Qualifier
| |xref:Spec/Metamodel_Common.adoc#Qualifier[Qualifier] |No longer inherits from abstract class "Constraint"
...
| |xref:Spec/Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |Before as specified via DataTypeDef, now any xsd atomic type as specified via DataTypeDefXsd
|{empty}x |View |Removed
|===
...
| |xref:Spec/Metamodel_Referencing.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References

| |xref:Spec/Metamodel_Referencing.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
...
| |xref:Spec/Metamodel_Core.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset, because not specific to Asset but to AAS
...
| |xref:Spec/Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] a|
...
| |BasicEventElement/state |Was part of non-normative part before
| |xref:Spec/Metamodel_DataTypes.adoc#ContentType[ContentType] |Former name: MimeType
| |dateTimeStamp |New data type for metamodel as used in EventPayload
| |xref:Spec/Metamodel_DataTypes.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + prefix rdf: added to every value in enumeration
| |DataTypeDefXsd a|
...
| |xref:Spec/Metamodel_SubmodelElements.adoc#Direction[Direction] |New enumeration for BasicEventElement
| |xref:Spec/Metamodel_Environment.adoc#Environment[Environment] |New class for entry point for Asset Administration Shells, submodels and concept descriptions
| |xref:Spec/Metamodel_SubmodelElements.adoc#EventElement[EventElement] |Former name: Event

| |xref:Spec/Metamodel_SubmodelElements.adoc#EventPayload[EventPayload] |New class for event payload
...
| |xref:Spec/Metamodel_Common.adoc#Extension[Extension] |New class, part of new abstract class HasExtensions
| |xref:Spec/Metamodel_Referencing.adoc#FragmentKeys[FragmentKeys] |New enumeration used for References
| |xref:Spec/Metamodel_Referencing.adoc#GenericFragmentKeys[GenericFragmentKeys] |New enumeration used for References
| |GenericGloballyIdentifiers |New enumeration used for References
| |xref:Spec/Metamodel_Referencing.adoc#GloballyIdentifiables[GloballyIdentifiables] |New enumeration used for References
| |xref:Spec/Metamodel_Common.adoc#HasExtensions[HasExtensions] |New abstract class, inherited by Referable
...
| |xref:Spec/Metamodel_Common.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
...
| |xref:Spec/Metamodel_Referencing.adoc#ReferenceTypes[ReferenceTypes] |New enumeration for Reference/type
| |xref:Spec/Metamodel_SubmodelElements.adoc#StateOfEvent[StateOfEvent] |New enumeration for BasicEventElement
| |xref:Spec/Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |New type for AssetInformation/specificAssetId
...
|{empty} |xref:Spec/Metamodel_SubmodelElements.adoc#SubmodelElementList[SubmodelElementList] |Before SubmodelElementCollection was used for lists and structs
...
|===
|*nc* |*V3.0RC02 Change w.r.t. V2.0.1* |*Comment*
| |xref:DataSpecifications.adoc#DataSpecification[DataSpecification] a|
...
| |xref:Spec/Metamodel_Common.adoc#AdministrativeInformation[AdministrativeInformation] |Bugfix: Stereotype "DataType" added
| |AnnotatedRelationship/annotation |Type changed from ModelReference<xref:Spec/Metamodel_SubmodelElements.adoc#DataElement[DataElement]> to DataElement
...
|x |Event |Renamed to EventElement
|x |Extension/refersTo |Type changed from Reference to ModelReference<xref:Spec/Metamodel_Common.adoc#Referable[Referable]>
...
| |Property/valueType |Type changed from DataTypeDef to DataTypeDefXsd
|x |Qualifiable/qualifier |Type changed from Constraint to Qualifier
| |xref:Spec/Metamodel_Common.adoc#Qualifier[Qualifier] |Does not inherit from abstract class "Constraint" any longer
| |Qualifier/valueType |Type changed from DataTypeDef to DataTypeDefXsd
| |Range/valueType |Type changed from DataTypeDef to DataTypeDefXsd
| |Referable/idShort |Now optional, was mandatory
|x |ReferableElements |Substituted with enumeration AasSubmodelElements and AasIdentifiables
...
| |RelationshipElement/first |Type changes from model reference Referable to Reference (global or model reference)
| |RelationshipElement/second |Type changes from model reference Referable to Reference (global or model reference)
| |xref:Spec/Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |Before as specified via DataTypeDef, now any xsd atomic type as specified via DataTypeDefXsd + Prefix xs: added to every value in list
...
| |xref:Spec/Metamodel_Referencing.adoc#AasReferableNonIdentifiables[AasReferableNonIdentifiables] |New enumeration used for References
| |xref:Spec/Metamodel_Referencing.adoc#AasReferables[AasReferables] |New enumeration used for References, includes abstract Referable
| |xref:Spec/Metamodel_SubmodelElements.adoc#BasicEventElement[BasicEventElement] |Former name: BasicEvent
...
| |xref:Spec/Metamodel_DataTypes.adoc#ContentType[ContentType] |Former name: MimeType
| |xref:Spec/Metamodel_DataTypes.adoc#DataTypeDefRdf[DataTypeDefRdf] |Enumeration for types of Rdf + prefix rdf: added to every value in enumeration
| |xref:Spec/Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd] |Enumeration consisting of enumerations decimalBuildInTypes, durationBuildInTypes, PrimitiveTypes that correspond to anySimpleTypes of xsd. + prefix xs: added to every value in enumeration
| |dateTimeStamp |New data type for metamodel as used in EventPayload
...
| |xref:Spec/Metamodel_Common.adoc#QualifierKind[QualifierKind] |New enumeration for Qualifier/kind
| |Referable/checksum |
| |xref:Spec/Metamodel_Core.adoc#SpecificAssetId[SpecificAssetId] |Before: IdentifierKeyValuePair, was renamed
...
|x |AssetAdministrationShell/assetInformation |Substitute for AssetAdministrationShell/asset (no reference any longer, instead aggregation)
| |xref:Spec/Metamodel_Core.adoc#AssetInformation[AssetInformation] |with attributes/functionality from former class Asset because not specific to Asset but AAS
| |AssetInformation/thumbnail |Optional Attribute of new class AssetInformation that was not available in Asset class before
...
| |xref:DataSpecifications.adoc#DataSpecification[DataSpecification] |Bugfix, is not abstract
...
| |xref:DataSpecifications.adoc#HasDataSpecification[HasDataSpecification] |Was abstract before
...
|x |xref:Spec/Metamodel_SubmodelElements.adoc#OperationVariable[OperationVariable] |No longer inherits from SubmodelElement
...
|===
|*V2.0* |*Comment*
|xref:Spec/Metamodel_SubmodelElements.adoc#AnnotatedRelationshipElement[AnnotatedRelationshipElement] |New submodel element, inheriting from RelationshipElement
|Asset/billOfMaterial |New attribute
|xref:Spec/Metamodel_Core.adoc#AssetKind[AssetKind] |New enumeration type
|BasicEvent |New submodel element, inherits from Event
|xref:Spec/Metamodel_SubmodelElements.adoc#Capability[Capability] |New submodel element
...
|xref:Spec/Metamodel_SubmodelElements.adoc#Entity[Entity] |New submodel Element
|xref:Spec/Metamodel_SubmodelElements.adoc#EntityType[EntityType] |New enumeration type
...
|xref:Spec/Metamodel_DataTypes.adoc#LangStringSet[LangStringSet] |New type, used for example in MultiLanguageProperty
|LevelType |New enumeration type
|xref:Spec/Metamodel_Core.adoc#ModellingKind[ModellingKind] |New enumeration type
|xref:Spec/Metamodel_SubmodelElements.adoc#MultiLanguageProperty[MultiLanguageProperty] |New submodel element
|Qualifier/valueType |New attribute to be consistent with valueType of Property etc.
|xref:Spec/Metamodel_SubmodelElements.adoc#Range[Range] |New submodel element
...
|xref:Spec/Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |New type, used for example for Property value
|ValueList |New class
