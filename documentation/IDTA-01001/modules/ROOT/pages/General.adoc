...
In the domain of smart manufacturing, the assets need to be uniquely identified worldwide xref:Bibliography.adoc#bib4[[4\]] xref:Bibliography.adoc#bib20[[20\]] by the means of identifiers (IDs). The Administration Shell also has a unique ID (see Figure 5).
