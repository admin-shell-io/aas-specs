...
xref:Spec/IDTA-01001_Metamodel_Common.adoc#AdministrativeInformation[AdministrativeInformation] allows the usage of templates (xref:Spec/IDTA-01001_Metamodel_Common.adoc#HasDataSpecification[HasDataSpecification]). Data specifications are defined in separate documents.
...
h|Inherits from: 3+|xref:Spec/IDTA-01001_Metamodel_Common.adoc#HasDataSpecification[HasDataSpecification]
...
|Version of the element |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#VersionType[VersionType] |0..1

.2+e|revision 3+| `\https://admin-shell.io/aas/3/1/AdministrativeInformation/revision`  
|Revision of the element |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#RevisionType[RevisionType] |0..1

.2+e|creator 3+| `\https://admin-shell.io/aas/3/1/AdministrativeInformation/creator`  
a|The subject ID of the subject responsible for making the element |xref:Spec/IDTA-01001_Metamodel_Referencing.adoc#Reference[Reference] |0..1
...
|xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#Identifier[Identifier] |0..1
...
a|An extension of the element. |xref:Spec/IDTA-01001_Metamodel_Common.adoc#Extension[Extension] |0..*
...
a|Name of the extension |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#NameType[NameType] |1
...
|xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd]|0..1

.2+e|value 3+| `\https://admin-shell.io/aas/3/1/Extension/value` 
a|Value of the extension |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |0..1

.2+e|refersTo 3+| `\https://admin-shell.io/aas/3/1/Extension/refersTos` 
a|Reference to an element the extension refers to |ModelReference<xref:Spec/IDTA-01001_Metamodel_Common.adoc#Referable[Referable]> |0..*
|===
...
|xref:Spec/IDTA-01001_Metamodel_Common.adoc#ModellingKind[ModellingKind]|0..1
...
h|Inherits from: 3+|xref:Spec/IDTA-01001_Metamodel_Common.adoc#Referable[Referable]
...
|xref:Spec/IDTA-01001_Metamodel_Common.adoc#AdministrativeInformation[AdministrativeInformation] |0..1

.2+e|id 3+| `\https://admin-shell.io/aas/3/1/Identifiable/id`  

a|The globally unique identification of the element |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#Identifier[Identifier] |1
...
a|Additional qualification of a qualifiable element |xref:Spec/IDTA-01001_Metamodel_Common.adoc#Qualifier[Qualifier] |0..*
|===
...
|xref:Spec/IDTA-01001_Metamodel_Common.adoc#QualifierKind[QualifierKind] |0..1

.2+e|type 3+| `\https://admin-shell.io/aas/3/1/Qualifier/type`  
a|The qualifier type describes the type of qualifier that is applied to the element. |xref:Spec/IDTA-01001_Metamodel_Common.adoc#QualifierType[QualifierType] |1

.2+e|valueType 3+| `\https://admin-shell.io/aas/3/1/Qualifier/valueType`  
a|Data type of the qualifier _value_ |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#DataTypeDefXsd[DataTypeDefXsd] |1

.2+e|value 3+| `\https://admin-shell.io/aas/3/1/Qualifier/value`  
a|The qualifier value is the value of the qualifier. |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#ValueDataType[ValueDataType] |0..1
...
Example of a _TemplateQualifier:_ a submodel element with qualifier value "mandatory" or "optional". This qualification is needed to build a correct submodel instance. For more information see xref:IDTA-01xxx_Bibliography.adoc#bib48[[48\]].
...
h|Inherits from: 3+|xref:Spec/IDTA-01001_Metamodel_Common.adoc#HasExtensions[HasExtensions]
...
|xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#NameType[NameType] |0..1
...
a|Display name; can be provided in several languages |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageNameType[MultiLanguageNameType] |0..1
...
|xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |0..1
|===
