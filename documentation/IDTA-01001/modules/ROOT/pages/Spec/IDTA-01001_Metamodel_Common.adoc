...
====
Note: it is recommended to use an external reference. This is even recommended in the case a xref:IDTA-01001_Metamodel_Designators.adoc#ConceptDescription[ConceptDescription] exists. Otherwise lookup of the corresponding concept description may fail.

In future releases a constraint may be added that makes is mandatory to use external references.
