...
====
Note 1: it is recommended to use an external reference, i.e. _Reference/type = ExternalReference_, compare to xref:Spec/Metamodel_Common.adoc#HasSemantics[HasSemantics/semanticId]
====
