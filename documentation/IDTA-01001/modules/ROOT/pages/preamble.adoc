...
Annex xref:annex/valueonly-serialization-example.adoc[ValueOnly-Serialization Example] and example of a Value-Only serialization as explained in Clause xref:mappings.adoc#value_only_serialization_in_json[Mappings] is given.
