...
a|Description of how and in which context the data specification template is applicable; can be provided in several languages. |xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |0..1
...
====
Note: This identifier is used as value for xref:Spec/IDTA-01001_Metamodel_Common.adoc#HasDataSpecification[HasDataSpecification/dataSpecification]
====

|xref:Spec/IDTA-01001_Metamodel_DataTypes.adoc#Identifier[Identifier] |1
...
|xref:IDTA-01001_DataSpecifications.adoc#DataSpecificationContent[DataSpecificationContent] |1
