...
_ID_ is the metamodel ID of the class or attribute, conformant to the grammar defined in Clause xref:mappings.adoc#reference-serialization[Text Serialization of Values of Type "Reference"].
...
If class type equal to "ModelReference<Submodel>", the following reference would be a valid reference (using the text serialization as defined in Clause xref:mappings.adoc#reference-serialization[Text Serialization of Values of Type "Reference"
]):
