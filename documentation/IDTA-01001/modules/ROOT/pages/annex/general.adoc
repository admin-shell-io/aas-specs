...
====
Note 1: to distinguish asset xref:terms-definitions-and-abbreviations.adoc#term-asset-type[type] and asset xref:terms-definitions-and-abbreviations.adoc#term-asset-instance[instance], the term xref:spec-metamodel/core.adoc#AssetKind[asset kind] is used in this document.
