...
Following the different identification types from Clause xref:annex/general.adoc#which-identifiers-for-which-elements[Which Identifiers for Which Elements?], it can be stated that:
