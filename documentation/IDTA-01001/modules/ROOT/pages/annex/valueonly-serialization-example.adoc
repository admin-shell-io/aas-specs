...
As mentioned in Clause xref:mappings/mappings.adoc#json-schema-value-only[JSON-Schema for the Value-Only Serialization],
...
in Clause xref:mappings/mappings.adoc#json-schema-value-only[JSON-Schema for the Value-Only Serialization]
