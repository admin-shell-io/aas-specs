...
include::./includes/GrammarSerializationReference.adoc[leveloffset=-1]

include::./includes/EmbeddedDataSpecifications.adoc[leveloffset=-1]

include::./includes/MetaDataObjects.adoc[leveloffset=-1]
