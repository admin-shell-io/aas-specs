...
a|Description of how and in which context the data specification template is applicable; can be provided in several languages. |xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#MultiLanguageTextType[MultiLanguageTextType] |0..1
...
|xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#AdministrativeInformation[AdministrativeInformation] |0..1
...
====
Note: This identifier is used as value for xref:page$Spec/IDTA-01001_Metamodel_Common.adoc#HasDataSpecification[HasDataSpecification/dataSpecification]
====

|xref:page$Spec/IDTA-01001_Metamodel_DataTypes.adoc#Identifier[Identifier] |1
...
|xref:page$IDTA-01001_DataSpecifications.adoc#DataSpecificationContent[DataSpecificationContent] |1
