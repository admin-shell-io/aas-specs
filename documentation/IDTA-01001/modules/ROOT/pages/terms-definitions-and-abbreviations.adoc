...
description of a set of objects that share the same xref:terms-definitions-and-abbreviations.adoc#term-attribute[attributes], xref:terms-definitions-and-abbreviations.adoc#term-operation[opererations], methods, relationships, and semantics
...
well-defined element associated with a xref:terms-definitions-and-abbreviations.adoc#term-property[property] instance or xref:terms-definitions-and-abbreviations.adoc#term-submodel-element[submodel element], restricting the value statement to a certain period of time or use case
