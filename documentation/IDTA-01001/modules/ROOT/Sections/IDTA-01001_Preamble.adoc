...
This document (version 3.1) was produced from February 2023 to xxx 202y by the Work Stream "Specification of the Asset Administration Shell" of the Working Group "Open Technology" of the [Industrial Digital Twin Association](www.idtwin.org).
